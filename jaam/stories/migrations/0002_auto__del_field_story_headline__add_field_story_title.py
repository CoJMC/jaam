...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Story.headline'
        db.delete_column('stories_story', 'headline')

        # Adding field 'Story.title'
        db.add_column('stories_story', 'title', self.gf('django.db.models.fields.CharField')(default='Story Title', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Story.headline'
        db.add_column('stories_story', 'headline', self.gf('django.db.models.fields.CharField')(default='', max_length=200), keep_default=False)
