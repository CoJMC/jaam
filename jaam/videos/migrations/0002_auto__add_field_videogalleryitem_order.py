...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VideoGalleryItem.order'
        db.add_column('videos_videogalleryitem', 'order', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'VideoGalleryItem.order'
        db.delete_column('videos_videogalleryitem', 'order')
