...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Blog.cover_photo'
        db.alter_column('blog_blog', 'cover_photo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.Photo'], on_delete=models.SET_DEFAULT))
        # Deleting field 'BlogPost.author'
        db.rename_column('blog_blogpost', 'author_id', 'journalist_id')

        # Changing field 'BlogPost.cover_photo'
        db.alter_column('blog_blogpost', 'cover_photo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.Photo'], on_delete=models.SET_DEFAULT))
    def backwards(self, orm):

        # Changing field 'Blog.cover_photo'
        db.alter_column('blog_blog', 'cover_photo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.Photo']))
        # Adding field 'BlogPost.author'
        db.rename_column('blog_blogpost', 'journalist_id', 'author_id')

        # Changing field 'BlogPost.cover_photo'
        db.alter_column('blog_blogpost', 'cover_photo_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photos.Photo']))
    models = {
        'auth.group': {
        ...
        'blog.blog': {
            ...
            'cover_photo': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['photos.Photo']", 'on_delete': 'models.SET_DEFAULT'}),
        ...
        'photos.photo': {
            ...
            'exif_data': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['photos.PhotoExifData']", 'unique': 'True', 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'projects.project': {
            ...
            'coverGallery': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['photos.PhotoGallery']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('ckeditor.fields.RichTextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'infographic': ('django.db.models.fields.files.ImageField', [], {'max_length': '200'}),
