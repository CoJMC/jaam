...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Blog.cover_photo'
        db.add_column('blog_blog', 'cover_photo', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['photos.Photo']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Blog.cover_photo'
        db.delete_column('blog_blog', 'cover_photo_id')
