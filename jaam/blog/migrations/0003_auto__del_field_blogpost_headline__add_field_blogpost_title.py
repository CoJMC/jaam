...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BlogPost.headline'
        db.delete_column('blog_blogpost', 'headline')

        # Adding field 'BlogPost.title'
        db.add_column('blog_blogpost', 'title', self.gf('django.db.models.fields.CharField')(default='Blog Title', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'BlogPost.headline'
        db.add_column('blog_blogpost', 'headline', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Deleting field 'BlogPost.title'
        db.delete_column('blog_blogpost', 'title')
