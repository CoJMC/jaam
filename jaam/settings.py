...
DATABASES = {
    'default': {
        ...
        'NAME': 'tmp_local_jaam.db', # Or path to database file if using sqlite3.
...
MEDIA_ROOT = os.path.join(PROJECT_ROOT, "tmp", "media" + os.path.sep)
...
STATIC_ROOT = os.path.join(PROJECT_ROOT, "tmp", "static" + os.path.sep)
