...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PhotoExifData.gps_latitude'
        db.alter_column('photos_photoexifdata', 'gps_latitude', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'PhotoExifData.gps_longitude'
        db.alter_column('photos_photoexifdata', 'gps_longitude', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))
