...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.enable_comments'
        db.add_column('photos_photo', 'enable_comments', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.enable_comments'
        db.delete_column('photos_photo', 'enable_comments')
