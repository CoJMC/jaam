...
class PhotoExifData(models.Model):
    ...
    gps_latitude = models.CharField(max_length=45, null=True) # TODO: Make this a decimal value
    gps_longitude = models.CharField(max_length=45, null=True) # TODO: Make this a decimal value
