...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('journalism_userprofile', 'bio', self.gf('ckeditor.fields.RichTextField')(null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.major'
        db.add_column('journalism_userprofile', 'major', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('journalism_userprofile', 'bio')

        # Deleting field 'UserProfile.major'
        db.delete_column('journalism_userprofile', 'major')
