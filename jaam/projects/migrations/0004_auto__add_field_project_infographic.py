...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.infographic'
        db.add_column('projects_project', 'infographic',
                      self.gf('django.db.models.fields.files.ImageField')(default=0, max_length=200),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Project.infographic'
        db.delete_column('projects_project', 'infographic')
