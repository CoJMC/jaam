...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('projects_project', (
            ...
            ('coverGallery', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['photos.PhotoGallery'])),
        ))
        ...
        db.create_table('projects_project_locations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm['projects.project'], null=False)),
            ('projectlocation', models.ForeignKey(orm['projects.projectlocation'], null=False))
        ))
        db.create_unique('projects_project_locations', ['project_id', 'projectlocation_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('projects_project_locations')
