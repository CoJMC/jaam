...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.primaryColor'
        db.add_column('projects_project', 'primaryColor', self.gf('django.db.models.fields.CharField')(default='FF0000', max_length=7), keep_default=False)

        # Adding field 'Project.accentColor'
        db.add_column('projects_project', 'accentColor', self.gf('django.db.models.fields.CharField')(default='FFFFFF', max_length=7), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Project.primaryColor'
        db.delete_column('projects_project', 'primaryColor')

        # Deleting field 'Project.accentColor'
        db.delete_column('projects_project', 'accentColor')
